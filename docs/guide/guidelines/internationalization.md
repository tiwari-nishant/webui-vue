...
- We use the `$t()` function in markup and `i18n.global.t` in scripts (which Vue
  I18n provides to our components) for outputting translation messages.
...
- Vue I18n’s `$tc()` function can help with displaying plurals.
  [Learn more about pluralization.](https://vue-i18n.intlify.dev/guide/essentials/pluralization.html#custom-pluralization)
