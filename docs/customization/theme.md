...
will require becoming familiar with the Bootstrap and Bootstrap-vue-next
component libraries. This section outlines the global options and variables that
can be removed or updated to meet organizational brand guidelines.
...
- [Carbon Design System Motion Guidelines](https://carbondesignsystem.com/elements/motion/overview/)
...
Bootstrap-Vue-next components `variant` prop also utilizes the `theme-color`
map. This map is the key to customizing the application's color palette. Take a
look at the [color guidelines](/guide/guidelines/colors) to better understand
